...
public class CommonHandler {
	...
	public void registerPaintings(Register<PaintingType> event) {
		((RegistryEvent.Register<PaintingType>) event).getRegistry().register((new PaintingType(64,64)).setRegistryName(Artimancy.MODID, "alch_painting"));
	}
