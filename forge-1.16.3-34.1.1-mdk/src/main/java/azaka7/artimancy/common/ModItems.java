...
public class ModItems {
	...
	private ModItems(){
		...
		silver_plate = new MiscItem("silver_plate",ItemGroup.MATERIALS, itemList);
		...
		silver_tower_shield = new ArmorShieldItem("silver_tower_shield", ModArmorMaterial.SILVER, ItemGroup.COMBAT, itemList, 1.0f);
		...
		new SpellScrollItem("light_spell_scroll", Spells.LIGHT, ItemGroup.BREWING, itemList);
		...
		cast_iron_hoe = new ModHoeItem("cast_iron_hoe", ToolTier.CAST_IRON, -2, -0.0F, ItemGroup.TOOLS, itemList);
		...
		steel_hoe = new ModHoeItem("steel_hoe", ToolTier.STEEL, -2, -0.5F, ItemGroup.TOOLS, itemList);
		...
		silver_hoe = new ModHoeItem("silver_hoe", ToolTier.SILVER, -1, -0.0F, ItemGroup.TOOLS, itemList);
