...
public class ArmorShieldItem extends Item{
	...
	public ArmorShieldItem(String name, IArmorMaterial materialIn, ItemGroup tab, ImmutableList.Builder<Item> itemList, float speed) {
		...
		builder.put(Attributes.field_233826_i_, new AttributeModifier(SHIELD_MODIFIERS, "Armor modifier", (double)this.damageReduceAmount, AttributeModifier.Operation.ADDITION));
		builder.put(Attributes.field_233827_j_, new AttributeModifier(SHIELD_MODIFIERS, "Armor toughness", (double)this.toughness, AttributeModifier.Operation.ADDITION));
		if(speedMod != 1.0f) {
			builder.put(Attributes.field_233821_d_, new AttributeModifier(SHIELD_MODIFIERS, "Movement Speed", (double)this.speedMod, AttributeModifier.Operation.MULTIPLY_BASE));
		}
	...
	{
		return enchantment.type.equals(EnchantmentType.BREAKABLE) || enchantment.type.equals(EnchantmentType.ARMOR_CHEST) || enchantment.equals(Enchantments.KNOCKBACK) ? true : enchantment.type.canEnchantItem(stack.getItem());
	}
