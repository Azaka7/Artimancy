...
public class SlotCastingOutput extends Slot{
	/** The player that is using the GUI where this slot resides. */
	   private final PlayerEntity player;
	   private int removeCount;

	   public SlotCastingOutput(PlayerEntity player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
	   ...
	   protected void onCrafting(ItemStack stack) {
	      ...
	      if (!this.player.world.isRemote) {
	         /*for(Entry<ResourceLocation, Integer> entry : ((TileEntityCastFurnace)this.inventory).getRecipeUseCounts().entrySet()) {
