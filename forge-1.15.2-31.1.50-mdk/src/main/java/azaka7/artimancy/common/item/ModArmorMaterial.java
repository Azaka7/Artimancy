...
public class ModArmorMaterial implements IArmorMaterial{
	...
	public static final IArmorMaterial SILVER = new ModArmorMaterial(Artimancy.MODID+":silver", 8, new int[] {2,3,5,2},18,"silver_plate", 0.0F, SoundEvents.ITEM_ARMOR_EQUIP_GOLD);
	public static final IArmorMaterial SILVER_LEATHER = new ModArmorMaterial(Artimancy.MODID+":silver_plated", 6, new int[] {1,3,4,2},18,"silver_plate", 0.0F, SoundEvents.ITEM_ARMOR_EQUIP_GOLD);
