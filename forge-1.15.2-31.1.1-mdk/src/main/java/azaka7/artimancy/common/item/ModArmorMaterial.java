...
public class ModArmorMaterial implements IArmorMaterial{
	...
	public static final IArmorMaterial CASTIRON_LEATHER = new ModArmorMaterial(Artimancy.MODID+":cast_iron_plated", 8, new int[] {3,6,8,3},13,"plate_cast_iron", 0.5F, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND);
